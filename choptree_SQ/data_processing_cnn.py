...
def preprocess_data(episodes):
    ...
    for episode in episodes:
        for transition in episode:
            # Prepare POV image in shape (3, 64, 64)
...
def main():
    ...
    if good_eps:
        ...
        save_processed_data(processed_good, "processed_data/processed_good_cnn.npz")

    if bad_eps:
        print("Processing bad episodes ...")
        processed_bad = preprocess_data(bad_eps)
        save_processed_data(processed_bad, "processed_data/processed_bad_cnn.npz")
